...
### 긴 소개글 작성법 (LinkedIn 등 에세이형 공유)
프로젝트 공유 시 사용자가 긴 글을 요청하면, 아래 구조를 따른다. 짧은 글은 긴 글에서 핵심만 추린다.

**구조 (실제 사례 기반):**
1. **철학적 화두로 시작** — 프로젝트의 기술이 아니라 *왜 이것을 만들게 되었는지* 근본 질문을 던진다
   - 예: "Leverage: 어떻게 일당백을 할 것인가?" → 경영 vs 성장, 위임 vs 자기복제
2. **개인적 맥락** — 현재 어떤 연구/문제를 풀고 있고, 왜 이것이 중요한지
   - 예: 서울대 3개 로봇 연구실 공동 연구, 제조업 Physical AI를 위한 로봇핸드
3. **만든 과정과 규모** — 구체적 숫자와 방법으로 임팩트 전달
   - 예: "5개 agent, 3시간, 146편 논문 조사 → 13챕터 책 + IEEE T-RO 양식 survey paper"
4. **인사이트/교훈** — 만들면서 느낀 시대적 통찰
   - 예: "만드는 건 쉽고 선별하는 눈은 귀하다", "누가 이미 한 것은 금방 복제될 수 있다"
5. **감사와 기여 인정** — 도움 준 사람/커뮤니티 언급
6. **마무리** — 누구에게 도움이 될지 + 링크 안내

**핵심 톤:**
- **사색적이고 솔직한 1인칭** — "내 머리는 예전보다 멍청해졌어도", "아직 안 읽어봤음;;"
- **겸손하지만 자신감** — 자기 한계를 인정하면서도 AI로 보완하는 전략에 대한 확신
- **시대적 맥락 위에 개인 경험** — 거시적 트렌드(AI 시대, leverage)를 자기 이야기로 구체화
