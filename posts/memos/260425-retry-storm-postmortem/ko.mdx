...
subtitle: "그날 무엇이 일어났고 내 책임은 무엇이었나"
summary: "4월 9~12일, KAIST 단일 IP에서 약 5천만 edge requests가 한 서베이 사이트의 깨진 이미지 3개에 retry storm으로 들어왔다. figure 경로 stale + `onerror` 자기 루프 + 외부 자동화의 종료 조건 없는 retry가 곱해진 결과였다. 코드 한 줄, 호스팅 이전, 알림 셋업으로 같은 사고 재발 시 금전 손실 0의 상태로 복구."
card_summary: "5천만 회 두드린 봇과, 그걸 4일간 인지조차 못한 내 잘못."
terrys_memo: ""
---
