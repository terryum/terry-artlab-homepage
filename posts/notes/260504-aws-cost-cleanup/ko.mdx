---
locale: "ko"
title: "월 $972 → $54: 한 달간의 AWS 청소 회고"
subtitle: "94% 감소까지의 세 청소 이벤트"
summary: "AWS Health 의 EOL 알림 두 통이 한 달간의 인프라 청소를 트리거했다. 폐기 결정만 났을 뿐 시간당 과금을 토하던 ECS fleet 일괄 폐기, Python Lambda 의 TypeScript 포팅 후 폐기, dead RDS bi + Node 16 stack 4개 정리. daily run-rate $22 → $1.75 (94% 감소). 폐기 결정 ≠ 인프라 삭제, NAT Gateway 의 sneakyness, cross-account boundary cutover 순서 등 정비 패턴을 정리한다."
card_summary: "AWS Health EOL 알림이 트리거한 한 달 청소. ECS fleet · Python Lambda · RDS bi 등 세 단계 폐기로 daily $22 → $1.75 (94% 감소)."
terrys_memo: ""
---
...
- 하루짜리 부채 정비([하루 만에 고친 SkinChat 인프라 부채](/ko/posts/260420-one-day-recovery))의 한 달 후 결과임
